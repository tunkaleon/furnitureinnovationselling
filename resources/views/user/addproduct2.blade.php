                                    ...
                                    <form id="validationform" data-parsley-validate="" novalidate="" method="POST" action="{{ url('add_product') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                <textarea name="description" id="" cols="5" rows="3" class="form-control" placeholder="enter atleast one line"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                {{-- <input type="text" required="" placeholder="product description" class="form-control" name="description" required> --}}
                                                <textarea name="moredescription" id="" cols="5" rows="3" class="form-control" placeholder="enter more description"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12 col-sm-8 col-lg-6">
                                                    ...
                                                    <select name="category" id="" class="form-control">
                                                        <option value="select ctegory">Select category</option>
