...
<head>
    ...
    <title>eshop</title>
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="admin/pages/../assets/vendor/bootstrap/css/bootstrap.min.css">
    <link href="admin/pages/../assets/vendor/fonts/circular-std/style.css" rel="stylesheet">
    <link rel="stylesheet" href="admin/pages/../assets/libs/css/style.css">
    <link rel="stylesheet" href="admin/pages/../assets/vendor/fonts/fontawesome/css/fontawesome-all.css">
    <link rel="stylesheet" type="text/css" href="admin/pages/../assets/vendor/datatables/css/dataTables.bootstrap4.css">
    <link rel="stylesheet" type="text/css" href="admin/pages/../assets/vendor/datatables/css/buttons.bootstrap4.css">
    <link rel="stylesheet" type="text/css" href="admin/pages/../assets/vendor/datatables/css/select.bootstrap4.css">
    <link rel="stylesheet" type="text/css" href="admin/pages/../assets/vendor/datatables/css/fixedHeader.bootstrap4.css">
</head>
...
John Abraham</h5>
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        ...
                                        <tbody>
                                            @foreach ($data as $data)
                                                ...
                                                <tr>
                                                    <td style="width:10%"><img src="/img/{{ $data->image }}" width="40%"> </td>
                                                    <td>{{ $data->product_name }} </td>
                                                    <td style="width:30%">{{ $data->description }}</td>
                                                    <td>{{ $data->quantity }}</td>
                                                    <td>{{ $data->price }}</td>
                                                    <td>{{ $data->category }}</td>
                                                    <td ><a onclick ="return confirm('are you sure you want to delete?')" href="{{ url('delete_product',$data->id) }}" class="btn btn-danger">delete</a></td>
    ...
    <!-- ============================================================== -->
    <!-- Optional JavaScript -->
    <script src="admin/pages/../assets/vendor/jquery/jquery-3.3.1.min.js"></script>
    <script src="admin/pages/../assets/vendor/bootstrap/js/bootstrap.bundle.js"></script>
    <script src="admin/pages/../assets/vendor/slimscroll/jquery.slimscroll.js"></script>
    <script src="admin/pages/../assets/vendor/multi-select/js/jquery.multi-select.js"></script>
    <script src="admin/pages/../assets/libs/js/main-js.js"></script>
    <script src="https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js"></script>
    <script src="admin/pages/../assets/vendor/datatables/js/dataTables.bootstrap4.min.js"></script>
    <script src="https://cdn.datatables.net/buttons/1.5.2/js/dataTables.buttons.min.js"></script>
    <script src="admin/pages/../assets/vendor/datatables/js/buttons.bootstrap4.min.js"></script>
    <script src="admin/pages/../assets/vendor/datatables/js/data-table.js"></script>
